...
### 🔴 Priority 1 — Quick Wins (1-2 hrs each)
...
| ID | Task | Completed |
|----|------|-----------|
| C1 | Click Ripple on miss | ✅ v1.0.0 |
| C2 | SaveManager persistence | ✅ v1.0.0 |
| C3 | SettingsMenu | ✅ v1.0.0 |
| C4 | Leaderboard top 10 | ✅ v1.0.0 |
| C5 | Combo/Chain system | ✅ v1.0.0 |
...
| ID | Task | Status |
|----|------|--------|
| TD1 | Fix environment config | ✅ DONE |
| TD2 | Rename package | ✅ DONE |
| TD3 | Update title | ✅ DONE |
